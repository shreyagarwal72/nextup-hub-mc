...
const Index = () => {
  ...
  return (
    <main className="min-h-screen bg-background relative overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/2 w-36 h-36 rounded-full bg-primary/10 blur-3xl floating-orb" style={{ animationDelay: '3s' }} />
      
      {/* Main Content */}
      <div className="relative z-10 container mx-auto px-4 py-20">
        {/* Hero Section */}
        <header className="text-center mb-20 animate-fade-in">
          <h1 className="text-6xl md:text-7xl lg:text-8xl font-bold mb-6 bg-gradient-to-r from-primary via-primary/90 to-primary/70 bg-clip-text text-transparent drop-shadow-2xl">
            Minecraft Hub
          </h1>
        ...
        {/* Edition Cards */}
        <section className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto" aria-label="Minecraft Editions">
          {/* Bedrock Edition Card */}
          <article className="group bg-card/50 backdrop-blur-sm border border-border/50 hover:border-primary/50 transition-all duration-500 hover:shadow-2xl hover:shadow-primary/20 animate-scale-in rounded-2xl overflow-hidden">
          ...
          {/* Java Edition Card */}
          <article className="group bg-card/50 backdrop-blur-sm border border-border/50 hover:border-primary/50 transition-all duration-500 hover:shadow-2xl hover:shadow-primary/20 animate-scale-in rounded-2xl overflow-hidden" style={{ animationDelay: '0.1s' }}>
            <Card className="bg-transparent border-none">
              <CardHeader className="text-center pb-4 pt-8">
                <CardTitle className="text-3xl md:text-4xl font-bold text-primary mb-3 transition-all duration-300 group-hover:scale-105">
                  Java Edition
